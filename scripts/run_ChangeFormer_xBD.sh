...
#Set paths
checkpoint_root=/u/mnitsche/ChangeFormer/checkpoints
vis_root=/u/mnitsche/ChangeFormer/vis
data_name=xBD
...
pretrain=checkpoints/CD_ChangeFormerV6_LEVIR_b16_lr0.0001_adamw_train_test_200_linear_ce_multi_train_True_multi_infer_False_shuffle_AB_False_embed_dim_256/best_ckpt.pt
