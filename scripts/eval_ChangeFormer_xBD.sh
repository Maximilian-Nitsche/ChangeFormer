...
project_name=CD_ChangeFormerV6_xBD_b8_lr0.0001_adamw_train_test_200_linear_ce_multi_train_True_multi_infer_False_shuffle_AB_False_embed_dim_256
checkpoints_root=/u/mnitsche/ChangeFormer/checkpoints
